// components/connection/modals/slack-modal.tsx
'use client';
...
export default function SlackModal({ platform, onClose, onConnect }: SlackModalProps) {
  const [config, setConfig] = useState({
    sourceName: 'Slack Source',
    apiKey: '',
  ...
  <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-gray-900">Configure Slack</h2>
        <button
          onClick={onClose}
