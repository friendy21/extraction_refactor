// components/connection/modals/google-workspace-modal.tsx
'use client';

import React, { useState } from 'react';
import { PlatformConfig } from '@/types/connection';
import { useConnectDataSource } from '@/hooks/api';
...
export default function GoogleWorkspaceModal({ platform, onClose, onConnect }: GoogleWorkspaceModalProps) {
  const [config, setConfig] = useState({
    sourceName: 'Google Workspace Source',
    apiKey: '',
    endpointUrl: 'https://www.googleapis.com/gmail/v1/',
  ...
  const features = [
    ...
    { id: 'Meet Recordings', name: 'Meet Recordings', icon: '📹' },
  ];
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-gray-900">Configure Google Workspace</h2>
          <button
            onClick={onClose}
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Google Workspace Source"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder="https://www.googleapis.com/gmail/v1/"
              />
            </div>
          </div>
