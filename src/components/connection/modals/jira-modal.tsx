// components/connection/modals/jira-modal.tsx
'use client';
...
export default function JiraModal({ platform, onClose, onConnect }: JiraModalProps) {
  const [config, setConfig] = useState({
    sourceName: 'Jira Source',
    apiKey: '',
    endpointUrl: 'https://your-domain.atlassian.net/rest/api/3/',
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-gray-900">Configure Jira</h2>
          <button
            onClick={onClose}
