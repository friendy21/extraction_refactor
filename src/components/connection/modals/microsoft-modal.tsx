// components/connection/modals/microsoft-modal.tsx
'use client';
...
export default function MicrosoftModal({ platform, onClose, onConnect }: MicrosoftModalProps) {
  ...
  const features = [
    ...
    { id: 'Calendar Events', name: 'Calendar Events', icon: '📅' },
    { id: 'Documents', name: 'Documents', icon: '📄' },
    { id: 'Team Chats', name: 'Team Chats', icon: '💬' },
  ];
      ...
      <div className="p-6">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  {showApiKey ? (
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L12 12l-2.122-2.122m7.121.707a3 3 0 11-4.243-4.243 3 3 0 014.243 4.243z" />
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-900 mb-2">Endpoint URL</label>
              <input
                type="url"
          ...
          {/* Refresh Interval */}
          <div>
            <label className="block text-sm font-semibold text-gray-900 mb-2">Refresh Interval</label>
            <select
          ...
          {/* Data Types */}
          <div>
            <label className="block text-sm font-semibold text-gray-900 mb-3">Select Data Types</label>
            <div className="grid grid-cols-2 gap-4">
              {features.map((feature) => (
                <label key={feature.id} className="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
                  <input
                    type="checkbox"
        ...
        <div className="flex justify-end space-x-3 pt-6 mt-6 border-t border-gray-200">
          ...
          <button
            ...
            className="px-6 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-md disabled:opacity-50 disabled:cursor-not-allowed flex items-center transition-colors"
          >
            {isConnecting && (
